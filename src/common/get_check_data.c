...
//	const char *b = SPI_getvalue(*tuple, *tupdesc, info.colNumber);
//	
//	char sz[128] = { 0 };
//
//    //DatumGetCString(SPI_getbinval(*tuple, *tupdesc, info.colNumber));
//	bool isnull = false;
//	const char *a = SPI_getbinval(*tuple, *tupdesc, info.colNumber, &isnull);
//	memcpy(sz, DatumGetCString(SPI_getbinval(*tuple, *tupdesc, info.colNumber, &isnull)), 128);
//
//	return sz;
//}
char*
pgr_SPI_getText(HeapTuple *tuple, TupleDesc *tupdesc, Column_info_t info) {
	...
	//const char *a = SPI_getvalue(*tuple, *tupdesc, info.colNumber);
	//return DatumGetCString(*a);
	//const char *a = SPI_getvalue(*tuple, *tupdesc, info.colNumber);
