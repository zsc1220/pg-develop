...
Datum test_add_fun(PG_FUNCTION_ARGS)
{
    ...
    pgr_edge_ts *edges = NULL;
    size_t total_edges = 0;
    //SPI_exec("set client_encoding = UTF8", 0);
    pgr_get_gedges(edges_sql, &edges, &total_edges);
...
//    sum = a - b;
//
//    pgr_get_gedges(edges_sql, &edges, &total_edges);   //数据读取函数
